    ...
    <div key="username" className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-white/8 border border-white/15 rounded-2xl px-4 py-3 text-white placeholder:text-white/30 outline-none focus:border-green-500/50 text-base"
          autoFocus
        />
