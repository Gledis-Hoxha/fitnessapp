        ...
        <motion.div
          ...
          className="border-t border-white/8 px-4 pb-4 pt-4 space-y-4 bg-gradient-to-b from-indigo-500/[0.06] to-transparent">
            ...
            <div className="space-y-4">
              ...
              className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white text-sm font-semibold transition-all shadow-lg shadow-indigo-500/20 disabled:opacity-50">
          ...
          <div>
              ...
              <div key={log.id} className="flex items-center justify-between rounded-xl bg-white/[0.03] border border-white/5 px-3 py-2">
                      <div className="flex items-center gap-2.5">
                        <div className={`w-2 h-2 rounded-full ${log.intensity === "high" ? "bg-indigo-400" : log.intensity === "moderate" ? "bg-yellow-400" : "bg-red-400"}`} />
                        <span className="text-xs text-white/55">{format(new Date(log.date + "T00:00:00"), "EEE MMM d")}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-semibold text-white tabular-nums">{Math.floor(log.duration_minutes / 60)}h {log.duration_minutes % 60}m</span>
