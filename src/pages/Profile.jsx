          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0 pt-1">
              ...
              <div className="flex flex-wrap gap-1.5 mt-2.5">
                {user?.fitness_goals?.slice(0, 2).map((g) => (
                  <span key={g} className="text-[10px] bg-blue-500/10 text-blue-300 border border-blue-500/15 px-2 py-0.5 rounded-full">
            ...
            <div className="flex items-center gap-1 flex-shrink-0 pt-1">
              ...
              <button
                ...
                className="px-4 py-2 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-xs font-semibold hover:opacity-90 transition-opacity shadow-lg shadow-blue-500/20 flex items-center gap-1.5">
